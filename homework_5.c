...
//递归
//int copystrlen(char* line)
//{
//	
//	int count = 0;
//	if (*line != '\0')
//	{
//		return 1+copystrlen(line+1);
//	}
//	else
//	{
//		return 0;
...
//{
//	char line[] = "nicotmoto";
//	int i = copystrlen(line);
//	printf("%d", i);
//	return 0;
//}
//13.字符串逆序：将参数字符串的字符反向排列
//非递归
//int copystrlen(char* line)
//{
//	if (*line != '\0')
...
//		return 0;
//}
//void reverse_str(char line[])
//{
//	int left = 0;
//	int right = copystrlen(line)-1;
//	
//	while (left <right)
//	{
//		int tmp = line[left];
...
//递归
//逆序reverse_str(abcdef)
//1.先交换a 和 f
//2.再逆序bcde（==reverse_str(bcde)
//详解：1.把a字符先拿出来  2.再把f拿到第一个字符的位置
//3.将最后一个字符串放\0，然后逆序bcde   4.a变换为\0的位置
//void restr(char line[])
//{
//	int tmp = line[0];
//	int len = strlen(line);
//	line[0] = line[len-1];
